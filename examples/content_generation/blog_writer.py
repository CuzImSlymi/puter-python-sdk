...
class BlogWriter:
    ...
    def full_blog_post(self, topic, target_audience="general readers", word_count=1000):
        ...
        title = title_match.group(1).strip() if title_match else f"The Ultimate Guide to {topic}"
    ...
    try:
        ...
        while True:
            ...
            if choice == '1':
                ...
                audience = input("Target audience (or press Enter for 'general'): ").strip()
                ...
                audience = input("Target audience (or press Enter for 'general'): ").strip()
                word_count = input("Target word count (or press Enter for 1000): ").strip()
