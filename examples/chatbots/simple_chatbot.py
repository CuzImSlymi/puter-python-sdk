...
def main():
    ...
    try:
        ...
        bot = SimpleChatbot(
            name="Buddy", 
            personality="friendly, witty, and knowledgeable"
        )
        ...
        if user_name:
            ...
            greeting = bot.chat("Hello! I'm ready to help. What would you like to talk about?")
            print(f"\n{bot.name}: {greeting}")
        ...
        while True:
            try:
                ...
                if user_input.lower() == 'quit':
                    # Farewell message
                    farewell = bot.chat("The user is saying goodbye. Please say a nice farewell message.")
                    print(f"\n{bot.name}: {farewell}")
                    break
