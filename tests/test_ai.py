...
class TestPuterAIAuthentication:
    ...
    def test_login_failure_invalid_credentials(self, puter_client, mock_requests):
        ...
        mock_response = Mock()
        mock_response.json.return_value = {"proceed": False, "error": "Invalid credentials"}
        mock_response.raise_for_status.return_value = None
        mock_requests.post.return_value = mock_response
...
class TestPuterAIChat:
    ...
    def test_chat_success(self, authenticated_client, mock_requests, sample_chat_response):
    ...
    def test_chat_with_specific_model(self, authenticated_client, mock_requests, sample_chat_response):
...
class TestPuterAIChatHistory:
    ...
    def test_chat_history_accumulation(self, authenticated_client, mock_requests, sample_chat_response):
        ...
        assert len(authenticated_client.chat_history) == 4  # 2 user + 2 assistant messages
...
class TestPuterAIRetryLogic:
    ...
    def test_retry_on_network_error(self, puter_client, mock_requests, sample_login_response):
